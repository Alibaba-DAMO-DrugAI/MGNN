...
suffixes = ['exp_eta2_n56', 'exp_eta5_n56', 'exp_eta10_n56', 'exp_eta20_n56',
...
def kfold_sars():
    gene_npy_sars()
    multi_scale_stacking_sars()


if __name__ == '__main__':
    if args.name.startswith('PDB'):
        pdbbind20xx(args.name)
    else:
        kfold_sars()